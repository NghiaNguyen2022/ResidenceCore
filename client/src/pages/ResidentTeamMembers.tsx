                  ...
                  <div className="mx-auto max-w-6xl space-y-5">
                        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                              ...
                              <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">
                                    Dành cho Tổ trưởng xem phạm vi Tổ mình đang phụ trách. Simple Mode hiện hiển thị các nhân sự đã được gắn trong cơ cấu của Tổ.
                              </p>
                        </section>
                                    ...
                                    >
                                          ...
                                          <div className="mt-4 space-y-3">
                                                {team.members?.length ? (
                                                      ...
                                                      <EmptyBox
                                                            title="Chưa có thành viên trong cơ cấu Tổ"
                                                            description="Danh sách thành viên sinh hoạt của Tổ sẽ được bổ sung ở bước tiếp theo."
                                                      />
                                                )}
                                          </div>
                                    </section>
