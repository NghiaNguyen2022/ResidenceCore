...
export const residenceMediumStyle = {
      ...
      topTitle: 'text-[32px] font-bold tracking-tight text-slate-900 drop-shadow-[0_1px_0_rgba(255,255,255,0.70)] sm:text-[38px]',
      ...
      chipBase:
            'inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-xs font-semibold ring-1 transition shadow-[0_4px_12px_rgba(120,53,15,0.035)] shadow-slate-900/5',
      chipActive: 'bg-slate-900 text-amber-900 ring-slate-900 shadow-[0_10px_24px_rgba(15,23,42,0.14)]',
      chipIdle: tone.chipIdle,
      chipCountActive: 'bg-white/15 text-amber-900',
      ...
      segmentedControl: 'flex rounded-xl bg-slate-100 p-1 text-sm font-semibold',
      ...
      cardTitle: 'min-w-0 text-xl font-semibold leading-7 text-slate-900',
      ...
      card:
            'relative overflow-visible rounded-xl border p-3 shadow-[0_18px_42px_rgba(120,53,15,0.08)] transition hover:-translate-y-0.5 hover:shadow-[0_24px_56px_rgba(120,53,15,0.12)]',
      cardActive: cx(tone.border, tone.cardGradient, 'hover:border-amber-200'),
      cardLeft: 'border-rose-200 bg-rose-50/80',
      cardInactive: 'border-amber-200 bg-amber-50/70/80',
      cardSection: cx(
            'rounded-xl border px-3 py-2.5 shadow-[0_4px_12px_rgba(120,53,15,0.035)] shadow-amber-900/5',
            tone.border,
            tone.cardSoftGradient
      ),

      listPanel:
            'overflow-hidden rounded-xl border border-amber-100/80 bg-[linear-gradient(180deg,#ffffff_0%,#fffdfa_100%)] shadow-[0_14px_34px_rgba(120,53,15,0.055)]',
      listPanelHeader:
      ...
      dropdownPanel:
            'absolute right-0 top-full z-50 mt-2 w-80 overflow-hidden rounded-xl border border-amber-100/80 bg-white/95 py-2 text-slate-800 shadow-[0_28px_60px_rgba(120,53,15,0.16)] backdrop-blur',
      dropdownLabel: 'px-4 pb-1 pt-2 text-[11px] font-semibold uppercase tracking-wide text-slate-400',
      dropdownItem: 'w-full px-3 py-1.5 text-left text-sm text-slate-700 transition hover:bg-amber-50/60',
      dropdownItemHint: 'mt-0.5 text-xs text-slate-400',
      divider: 'my-1 border-t border-amber-100/80',

      modalOverlay: 'fixed inset-0 z-[70] flex items-center justify-center bg-amber-700/45 px-4 py-5 backdrop-blur-sm',
      modalShell:
            'flex max-h-[92vh] w-full flex-col overflow-hidden rounded-xl border border-amber-100/80 bg-[linear-gradient(135deg,#ffffff_0%,#fffdf9_58%,#fff4e7_100%)] shadow-[0_30px_80px_rgba(15,23,42,0.20)]',
      modalHeader:
      ...
      modalTitle: 'text-xl font-bold tracking-tight text-slate-900',
      modalSubtitle: 'mt-1 text-sm leading-6 text-slate-500',

      metricCard:
            'rounded-xl border border-amber-100/80 bg-white/85 px-3 py-2.5 shadow-[0_6px_16px_rgba(120,53,15,0.04)]',
      ...
      secondaryButton:
            'rounded-xl border border-amber-100 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition hover:bg-amber-50/60 disabled:cursor-not-allowed disabled:opacity-60',
      primaryButton: cx(
            radius.button,
            'border px-3 py-1.5 text-sm font-bold transition hover:shadow-[0_14px_28px_rgba(180,83,9,0.18)] disabled:cursor-not-allowed disabled:opacity-60',
            tone.softBorder,
            tone.primaryButtonGradient,
            tone.accentText,
            tone.shadowSoft
      ...
      premiumGoldBlackPagePanel:
            'relative overflow-hidden rounded-xl border border-amber-100/65 bg-[linear-gradient(135deg,rgba(255,255,255,0.82)_0%,rgba(255,251,235,0.70)_48%,rgba(245,158,11,0.16)_76%,rgba(12,10,9,0.10)_100%)] shadow-[0_24px_64px_rgba(12,10,9,0.10),inset_0_1px_0_rgba(255,255,255,0.72)]',

      premiumGoldBlackPageSection:
            'relative overflow-hidden rounded-xl border border-amber-100/55 bg-[linear-gradient(145deg,rgba(255,255,255,0.76)_0%,rgba(255,251,235,0.58)_54%,rgba(248,250,252,0.70)_100%)] shadow-[0_18px_46px_rgba(12,10,9,0.075),inset_0_1px_0_rgba(255,255,255,0.72)]',

      premiumGoldBlackSoftSurface:
            'relative overflow-hidden rounded-xl border border-amber-100/45 bg-[linear-gradient(145deg,rgba(255,255,255,0.72)_0%,rgba(255,251,235,0.46)_60%,rgba(248,250,252,0.62)_100%)] shadow-[0_12px_30px_rgba(12,10,9,0.055)]',

      premiumPanel:
            'relative overflow-hidden rounded-xl border border-amber-100/65 bg-[linear-gradient(135deg,rgba(255,255,255,0.82)_0%,rgba(255,251,235,0.70)_48%,rgba(245,158,11,0.16)_76%,rgba(12,10,9,0.10)_100%)] p-3 shadow-[0_24px_64px_rgba(12,10,9,0.10),inset_0_1px_0_rgba(255,255,255,0.72)]',
      premiumSection:
            'relative overflow-hidden rounded-xl border border-amber-100/65 bg-[linear-gradient(135deg,rgba(255,255,255,0.82)_0%,rgba(255,251,235,0.70)_48%,rgba(245,158,11,0.16)_76%,rgba(12,10,9,0.10)_100%)] p-3 shadow-[0_24px_64px_rgba(12,10,9,0.10),inset_0_1px_0_rgba(255,255,255,0.72)]',
      premiumNestedSection:
            'relative overflow-hidden rounded-xl border border-amber-100/55 bg-[linear-gradient(145deg,rgba(255,255,255,0.78)_0%,rgba(255,251,235,0.58)_58%,rgba(248,250,252,0.70)_100%)] p-3 shadow-[0_16px_42px_rgba(12,10,9,0.075),inset_0_1px_0_rgba(255,255,255,0.72)]',
      premiumSubtleSection:
            'relative overflow-hidden rounded-xl border border-amber-100/50 bg-[linear-gradient(145deg,rgba(255,255,255,0.72)_0%,rgba(255,251,235,0.45)_58%,rgba(248,250,252,0.65)_100%)] p-3 shadow-[0_14px_36px_rgba(12,10,9,0.06)]',
      statCard:
            'relative overflow-hidden rounded-[24px] border border-amber-100/55 bg-[linear-gradient(135deg,rgba(255,255,255,0.78)_0%,rgba(255,251,235,0.56)_62%,rgba(245,158,11,0.12)_100%)] p-3 shadow-[0_16px_40px_rgba(12,10,9,0.075),inset_0_1px_0_rgba(255,255,255,0.70)]',
      statIcon: tone.iconBubble,
      actionBar: 'flex flex-wrap justify-end gap-2 px-1',
      disabledActionButton: cx(
            radius.button,
            'inline-flex cursor-not-allowed items-center gap-2 border bg-white/70 px-3 py-1.5 text-sm font-semibold text-slate-400 opacity-70',
            tone.softBorder
      ),
      orgChartPanel: cx(
