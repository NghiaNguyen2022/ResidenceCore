...
import type { CreateResidentUserFormData, Gender, MemberFormData } from './memberTypes';
                                                ...
                                                <div className="mt-4 space-y-4">
                                                      <div className="flex flex-col gap-3 md:flex-row md:items-end">
                                                            <div className="flex-1">
                                                                  <Label htmlFor="residentUsername">Tên đăng nhập</Label>
                                                                  <Input
                                                                        id="residentUsername"
                                                      ...
                                                      <div className="rounded-xl bg-white px-4 py-3 text-xs text-slate-500">
                                                            ...
                                                            Các chức danh như Tổ trưởng, Trưởng ban, Thủ quỹ sẽ được gán
                                                            sau từ quy trình bổ nhiệm.
                                                      </div>
                                                </div>
                                          )}
                                    </div>
