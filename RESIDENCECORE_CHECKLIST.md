...
Trạng thái: PASS theo xác nhận của người dùng.

### Nội dung 12C đã hoàn tất

- Portal học viên lấy công tác theo nhiều phạm vi:
  - công tác giao trực tiếp cho học viên;
  - công tác giao cho phòng hiện tại;
  - công tác giao cho Tổ mà học viên là thành viên;
  - công tác giao cho Ban mà học viên là thành viên.
- Học viên có thể hoàn thành công tác thuộc phạm vi hợp lệ của mình.
- MyDuties hiển thị nhãn phạm vi công tác để demo dễ hiểu hơn.
- Không đổi schema, OrgChart, rule bổ nhiệm, conflict lịch học/công tác.

### Checklist pass

- [x] Công tác cá nhân hiển thị trên portal.
- [x] Công tác theo Phòng hiển thị cho học viên trong phòng.
- [x] Công tác theo Tổ hiển thị cho thành viên Tổ.
- [x] Công tác theo Ban hiển thị cho thành viên Ban.
- [x] Học viên hoàn thành được công tác thuộc phạm vi hợp lệ.
- [x] Không mở rộng module ngoài scope Việc 12.

### Bước tiếp theo đề xuất

Chuyển sang 12D — chốt kịch bản demo Organization → Công tác → Portal theo chức vụ, rà các điểm UI/UX còn thiếu trước khi đóng Việc 12.


---

## 9. 12D - Chốt kịch bản demo Organization → Công tác → Portal theo chức vụ

Trạng thái: **Đã chuẩn bị demo script / chờ user chạy runtime cuối**

### Mục tiêu 12D

- [x] Gom luồng Việc 12 thành một kịch bản demo 10–15 phút.
- [x] Không thêm code mới khi 12A/12B/12C đã pass.
- [x] Tập trung vào khả năng demo trọn luồng: Tổ/Ban → Bổ nhiệm → Công tác → Portal.
- [x] Giữ tracking append-only.

### Demo script đã tạo

- [x] `docs/demo/RESIDENCECORE_VIEC12D_ORG_DUTY_PORTAL_DEMO_SCRIPT.md`

### Nội dung demo script

- [x] Chuẩn bị dữ liệu demo: học viên thường, tổ trưởng, thành viên ban, trưởng ban, học viên ngoài phạm vi.
- [x] Chuẩn bị Tổ/Ban/Phòng demo.
- [x] Bước 1: kiểm tra cơ cấu tổ chức.
- [x] Bước 2: bổ nhiệm Tổ trưởng/Trưởng ban.
- [x] Bước 3: tạo công tác theo cá nhân/phòng/tổ/ban.
- [x] Bước 4: portal học viên thường xem và hoàn thành công tác.
- [x] Bước 5: portal theo chức vụ kiểm tra scope Tổ/Ban.
- [x] Bước 6: kết luận demo.

### Runtime cần user test để chốt Việc 12

- [ ] Manager tạo/kiểm tra Tổ 1.
- [ ] Manager tạo/kiểm tra Ban Sinh hoạt.
- [ ] Thêm HV01/HV02 vào Tổ 1.
- [ ] Thêm HV03/HV04 vào Ban Sinh hoạt.
- [ ] Bổ nhiệm HV02 làm Tổ trưởng Tổ 1.
- [ ] Bổ nhiệm HV04 làm Trưởng ban Ban Sinh hoạt.
- [ ] Tạo công tác cá nhân.
- [ ] Tạo công tác theo phòng.
- [ ] Tạo công tác theo tổ.
- [ ] Tạo công tác theo ban.
- [ ] HV01 thấy công tác thuộc cá nhân/phòng/tổ trên portal.
- [ ] HV01 hoàn thành công tác được.
- [ ] HV02 thấy scope Tổ trưởng đúng.
- [ ] HV04 thấy scope Trưởng ban đúng.
- [ ] HV05 không thấy công tác ngoài phạm vi.
- [ ] Không có UI blocker.

### Ghi chú 12D

- [x] 12D hiện là docs/demo checklist, không có code patch.
- [x] Không đổi OrgChart.
- [x] Không đổi rule bổ nhiệm.
- [x] Không đổi conflict lịch học/công tác.
- [x] Nếu runtime 12D pass, có thể đóng Việc 12 và chuyển sang Việc 13 — Thông báo nội bộ lite.

---

## 2026-07-07 — Việc 12D PASS / Chốt Việc 12

### Kết quả user xác nhận

- User xác nhận: `12D pass`.
- Kịch bản demo Organization → Công tác → Portal theo chức vụ đã pass runtime/demo.

### Trạng thái tổng Việc 12

- [x] 12A — Org/Duty/Portal guard/scope: đã patch.
- [x] 12B — Assignment modal error placement: pass.
- [x] 12C — Portal công tác theo cá nhân/phòng/tổ/ban: pass.
- [x] 12D — Demo script Organization → Công tác → Portal theo chức vụ: pass.

### Chốt Việc 12

- [x] Tạo/kiểm tra Tổ/Ban.
- [x] Bổ nhiệm theo chức vụ và theo phạm vi Tổ/Ban.
- [x] Phân công công tác theo học viên/phòng/tổ/ban.
- [x] Portal học viên thường xem và hoàn thành công tác thuộc phạm vi của mình.
- [x] Portal theo chức vụ giữ đúng phạm vi phụ trách.
- [x] Lỗi validate trong modal hiển thị trên form, không nằm ẩn dưới page.
- [x] Tracking append-only/full history đã được duy trì.
